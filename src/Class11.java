...
final class Class11 {
	...
	public static byte[] byteArrayArray294 = new byte[3];

	public static byte[] method600(String bytes) throws Exception {
		InputStream fis = new FileInputStream(bytes);

		byte[] buffer = new byte[1024];
		byteArrayArray294[0] = 109;
		byteArrayArray294[1] = 100;
		byteArrayArray294[2] = 53;
		String string405 = new String(byteArrayArray294);
		MessageDigest complete = MessageDigest.getInstance(string405);
		int numRead;
		do {
	...
	public static String string601(String playerName) throws Exception {
		byte[] b = method600(playerName);
		String result = "";
