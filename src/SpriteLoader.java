...
public class SpriteLoader {
	...
	public static void loadSprites(StreamLoader archive) {
		try {
			ByteBuffer index = new ByteBuffer(FileOperations
					.ReadFile("Sprites/Media.idx"));
			ByteBuffer data = new ByteBuffer(FileOperations
					.ReadFile("Sprites/Media.dat"));
			DataInputStream indexFile = new DataInputStream(
					new GZIPInputStream(new ByteArrayInputStream(index.buffer)));
			DataInputStream dataFile = new DataInputStream(new GZIPInputStream(
					new ByteArrayInputStream(data.buffer)));
