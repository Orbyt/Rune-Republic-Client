public final class EntityDef {
	...
	public static EntityDef forID(int i) {
		...
		EntityDef_8.stuff(i);
		if (i == 15187) {
 entityDef.name = "Holiday Crusher";
	...
	public void readValues2(Stream stream) {
		do {
			...
			if (i == 1) {
				...
				anIntArray94 = new int[j];
				for (int j1 = 0; j1 < j; j1++) {
					anIntArray94[j1] = stream.readDWord();
					if (anIntArray94[j1] <= 29191 && anIntArray94[j1] != -1)
						anIntArray94[j1] = anIntArray94[j1] + 70000;
				}
			} else if (i == 2) {
				name = stream.readString();
			} else if (i == 3)
				...
				anIntArray73 = new int[l];
				for (int l1 = 0; l1 < l; l1++) {
					anIntArray73[l1] = stream.readDWord();
					if (anIntArray73[l1] <= 29191 && anIntArray73[l1] != -1)
						anIntArray73[l1] = anIntArray73[l1] + 70000;
				}
			} else if (i == 90)
				stream.readUnsignedWord();
			else if (i == 91)
