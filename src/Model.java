	...
	public Model(int modelId) {
		...
		if (newmodel[modelId]) {
			...
			if (anIntArray1638 != null) {
				if (modelId == 62693 || modelId == 62739 || modelId == 62756
						|| modelId == 62709 || modelId == 62744
						|| modelId == 62765 || modelId == 62695
						|| modelId == 62741 || modelId == 62757
						|| modelId == 65294 || modelId == 65315
						|| modelId == 65298 || modelId == 65317
						|| modelId == 65306 || modelId == 65323
						|| modelId == 65296 || modelId == 65321
						|| modelId == 65301 || modelId == 65324
						|| modelId == 65304 || modelId == 65319
						|| modelId == 65299 || modelId == 65326
						|| modelId == 65303 || modelId == 65320
						|| modelId == 65293 || modelId == 65325
						|| modelId == 65305 || modelId == 65318
						|| modelId == 65302 || modelId == 65327
						|| modelId == 65300 || modelId == 65322
						|| modelId == 65297 || modelId == 65316
						|| modelId == 65295 || modelId == 65328 || modelId == 60373 || modelId == 60523 || modelId == 60490 || modelId == 60664
						|| modelId == 62739 || modelId == 62756 || modelId == 62592 || modelId == 62575 || modelId == 62582) {
					for (int test = 0; test < anIntArray1638.length; test++) {
						anIntArray1638[test] = 10;
					}
				}
			}
		}
		// System.out.println("Loaded Model: " + modelId);
		// dumpModels(modelId);
	}

	public static void dumpModels(int modelID) {
		if (modelID != -1) {
			byte[] models = FileOperations.ReadFile("633Models/" + modelID
					+ ".dat");
			FileOperations.WriteFile("ModelFixes/" + modelID + ".dat", models);
		}
	}
