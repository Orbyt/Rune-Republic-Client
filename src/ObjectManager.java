...
final class ObjectManager {
	...
	private void method175(int i, WorldController worldController,
		...
		int mX = clientInstance.MapX - 6; //new
		int mY = clientInstance.MapY - 6;
		int actualX = mX * 8 + l;
		int actualY = mY * 8 + i;
		int actualH = k;
		if(!(actualX >= 3026 && actualX <= 3032 && actualY >= 3628 &&  actualY <= 3635) && 
			!( actualX >= 2654 && actualX <= 2669 && actualY >= 3296 &&  actualY <= 3316) && 
			!(actualX >= 3202 && actualX <= 3204 && actualY >= 3422 &&  actualY <= 3426)) {
	...
	public static client clientInstance; //new
