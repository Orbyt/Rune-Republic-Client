...
public final class Player extends Entity {
	...
	public Model getRotatedModel() {
		...
		if (super.anInt1520 != -1 && super.anInt1521 != -1) {
			...
			if (model_2 != null) {
				Model model_3 = new Model(true, Class36
						.method532(super.anInt1521), false, model_2);
				model_3.method475(0, -super.anInt1524, 0);
				model_3.method469();
				model_3
						.method470(spotAnim.aAnimation_407.anIntArray353[super.anInt1521]);
...
//e.printStackTrace();	
	...
	public Model method452() {
		...
		model_2
				.method464(model_1, Class36.method532(k)
						& Class36.method532(i1));
		if (k != -1 && i1 != -1)
